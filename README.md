...
### 代币详情页UI全面重构
- ✅ 改进Token Overview区域，集成更全面的数据点：价格、24h变化、市值、FDV、流动性、各类供应量、持有者数量及变化
- ✅ 添加合约地址显示，带区块浏览器链接和便捷的一键复制功能
- ✅ 整合官网及主要社交链接（Twitter, Telegram等）
- ✅ 移除冗余数据显示，优化布局为更紧凑、信息密度更高的多列网格设计
- ✅ 将价格变化和持有者数量变化的显示方式优化至与主数值同行
